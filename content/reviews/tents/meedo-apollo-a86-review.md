...
Output: meedo-apollo-a86-review.md
Site: MyCozyTrove
Category: tents
Article Type: COMMERCIAL_DECISION
AI Question: Meedo Apollo A86 M Review: A $1100 Rooftop Tent That Earns Its Price
Angle: Meedo Apollo A86 M vs Zeus I M — soft-shell vs hard-shell RTT decision guide on weight, setup time, rack compatibility, and price
Cluster: rooftop-tent-guide
Prior Coverage: none
Action Needed - Affiliate Links: yes — https://tidd.ly/4dXRbSn (3 instances), https://tidd.ly/4vfb66m (1 instance)
Hub Update Required: rooftop-tent-guide
HGD Blocks: n/a
Information Gain Source: Vehicle dynamic roof load limit vs. tent packed weight cross-reference calculation — derived from manufacturer weight specs (~120 lbs Apollo, ~170 lbs Zeus) against typical factory crossbar dynamic ratings (50–70 lbs) and a specific vehicle limit example (165 lbs); flags that Zeus I M exceeds a 165 lb vehicle roof limit before occupants, a step owner forums consistently identify as skipped. Also includes owner-reported setup time correction (3–5 min stated vs. 8–10 min actual in wind), sourced from overlanding forum reports referenced in draft.
