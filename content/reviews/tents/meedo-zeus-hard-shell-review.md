...
**<a href="[AFFILIATE_LINK_NEEDED — Meedo Apollo M Soft Shell Rooftop Tent]" target="_blank" rel="noopener noreferrer">Check Weight, Dimensions, and Price — Meedo Apollo M Soft Shell</a>**
...
Output: meedo-zeus-hard-shell-review.md
Site: MyCozyTrove
Category: tents
Article Type: COMMERCIAL_DECISION
AI Question: Meedo Zeus I M Hard Shell Review: 60-Second Setup Changes Everything
Angle: Meedo Zeus I M hard shell vs Apollo M soft shell — setup speed, roof load math, and field trade-offs for anglers and mobile campers
Cluster: rooftop-tent-guide
Prior Coverage: none
Action Needed - Affiliate Links: yes — [AFFILIATE_LINK_NEEDED — Meedo Zeus I M Hard Shell Rooftop Tent] (3 instances); [AFFILIATE_LINK_NEEDED — Meedo Apollo M Soft Shell Rooftop Tent] (1 instance); no /go/ paths available for either product
Hub Update Required: rooftop-tent-guide
HGD Blocks: n/a
Information Gain Source: Static load calculation (130 lb tent + 340 lb combined occupant weight = ~470 lb static load, requiring rack rated above 500 lbs static) derived by cross-referencing manufacturer weight spec against dynamic/static load rating distinction — not present on competing pages reviewed; owner-reported bedding snag quirk ("60 seconds to deployed, not 60 seconds to sleep-ready") sourced from rooftop tent owner forums
